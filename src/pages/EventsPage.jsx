import { Box, Heading, Input, SimpleGrid, Skeleton, Text } from "@chakra-ui/react";
...
export const EventsPage = () => {
  ...
  return (
    <Box p={{ base: 4, md: 8 }} maxW="1100px" mx="auto">
      ...
      <Box mb="6">
        <Text fontSize="xs" fontWeight="600" color="gray.400" mb="2" textTransform="uppercase" letterSpacing="wide">
          Filter op categorie
        </Text>
        <CheckboxList
      ...
      {!loading && filtered.length === 0 && (
        <Box textAlign="center" py="16" color="gray.400">
          ...
          <Text fontSize="sm" mt="1">Probeer een andere zoekterm of filter</Text>
        </Box>
      )}
    </Box>
  );
